...
//http://192.168.1.123:80/fxxt
	...
	public static final String GETCUXIAOMALLLIST="getCuXiaoMallClassifyList";

	public static final String GETGROUPMALLBYMALLID="getGroupMallByMallId";

	public static final String GETHOTMALLLIST="getHotMallClassifyList";
	...
	public static  final  String GETHOTATTENTIONLIST="getHotAttentionList";
	...
	public  static  final String Base_URL="http://www.laiworld.com/mobile/login.php?token=${token}&redirect_uri=";//member/edit.php
