...
/**
 * Created by joker on 2016/10/25.
 */
public class YouhuiTask extends AsyncTask<Void,Void,String> {
    private Context context;
    private boolean typeFlag=true;
    private boolean judgeInternet;
    private Map<String, String> map;
    public YouhuiTask(Context context, Map<String, String> map){
        this.map=map;
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            if (judgeInternet) {
                String url= VariablesOfUrl.APP_BASE_URL +VariablesOfUrl.GETCOUPONBYUSERID;
