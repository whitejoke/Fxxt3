...
public class AddAttentionTask extends AsyncTask<Void,Void,String> {
    ...
    public AddAttentionTask(Context context,Map<String,String> map){
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            if (judgeInternet) {
                String url = VariablesOfUrl.APP_BASE_URL +VariablesOfUrl.ADDATTENTION;// VariablesOfUrl.GETLOGOLIST;
