 ...
 */
public class FindJulebuDataTask extends AsyncTask<Void, Void, List<Post>> {
   ...
   private  GridListView listView;
    ...
    public FindJulebuDataTask(Context context, List<Post> listMessage, QshiqAdapter adapter, GridListView listView,MaterialRefreshLayout mlayout){
        super();
