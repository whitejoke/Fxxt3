 ...
 */
public class InformationDataTask extends AsyncTask<Void, Void, List<Information>> {
   ...
   private ListView listView;
    public InformationDataTask(Context context, List<Information> listMessage, InformationAdapter adapter, ListView listView){
        super();
