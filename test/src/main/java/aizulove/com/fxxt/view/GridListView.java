...
public class GridListView extends GridView implements OnScrollListener,android.widget.AdapterView.OnItemLongClickListener {
	...
	private OnMyGridViewRefreshListener refreshListener;
	...
	private void init(Context context) {
		...
		headView = (LinearLayout) inflater.inflate(R.layout.activity_list_head, null);
...
//		addHeaderView(headView, null, false);
	...
	public void onScrollStateChanged(AbsListView arg0, int scrollState) {
		...
		//   mRevoList.setSelection(visibleLastIndex);
		//   scrPos=mRevoList.getFirstVisiblePosition();
		//startLoadMoreTask(strLastTime,strExcept);// 获得>2页的数据并加载..可以用用//01-20 08:46:13.525: I/listview(272): 由done或者下拉刷新状态转变到松开刷新
	...
	public void setOnMyGridViewRefreshListener(OnMyGridViewRefreshListener refreshListener) {
		this.refreshListener = refreshListener;
		isRefreshable = true;
	}

	public interface OnMyGridViewRefreshListener {
