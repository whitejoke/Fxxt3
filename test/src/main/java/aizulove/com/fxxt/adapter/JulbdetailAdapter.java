...
/**
 * Created by joker on 2016/9/6.
 */
public class JulbdetailAdapter extends BaseAdapter {
    ...
    public JulbdetailAdapter(Context context, List<Post> list){
    ...
    public View getView(int postion, View convertView, ViewGroup parent) {
        ...
        for (int i = 0; i < imgs.length; i++){
            ...
            if (i==0) {
                if (null != imgs[i]&&!imgs[i].equals("")&&!imgs[i].equals("null")) {
